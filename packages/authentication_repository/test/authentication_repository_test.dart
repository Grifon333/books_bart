...
void main() {
  ...
  const password = 't5ge5h2rb';
  const user = User(
    uid: _mockFirebaseUserUid,
    name: _mockFirebaseUserName,
  ...
  group('Authentication Repository', () {
    ...
    group('signUp', () {
      ...
      test(
          'throws SignUpWithEmailAndPasswordFailure when createUserWithEmailAndPassword throws',
          () {
        when(
          () => firebaseAuth.createUserWithEmailAndPassword(
            email: any(named: 'email'),
    ...
    group('loginWithGoogle', () {
      ...
      test(
        'calls signIn authentication, and signInWithCredential',
        () async {
      ...
      test(
        'throws LogInWithGoogleFailure and calls signIn authentication, and signInWithPopup when authCredential is null and kIsWeb is true',
        () async {
      ...
      test(
        'successfully calls signIn authentication, and signInWithPopup when authCredential is not null and kIsWeb is true',
        () async {
    ...
    group('logInWithEmailAndPassword', () {
      ...
      test(
        'throws LogInWithEmailAndPasswordFailure when signInWithEmailAndPassword throws',
        () async {
          when(
            () => firebaseAuth.signInWithEmailAndPassword(
              email: any(named: 'email'),
    ...
    group('user', () {
      ...
      test('emits User when firebase user is not null', () async {
        ...
        when(() => firebaseUser.displayName).thenReturn(_mockFirebaseUserName);
